...
@section('title', 'Edit Event - Partner')

@section('page_title', 'Edit Event')

@section('page_subtitle', 'Ubah informasi event yang Anda selenggarakan.')

@section('content')

<div class="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm max-w-4xl">

    <form action="{{ route('partner.events.update', $event->id) }}"
          method="POST"
        ...
        @if($event->poster_path)
            ...
            <div>
                ...
                <img
                    ...
                    alt="{{ $event->title }}"
                    class="w-48 h-48 object-cover rounded-2xl border border-slate-100"
                >
            </div>
