...
@section('content')
    ...
    <section class="max-w-7xl mx-auto px-6 py-20 flex flex-col md:flex-row items-center gap-12">
        ...
        <div class="flex-1 relative">
            ...
            @if($events->count() > 0 && $events->first()->image)
                <img
                    src="{{ asset('storage/' . $events->first()->image) }}"
    ...
    {{-- ===================================================== --}}
{{-- SECTION DAFTAR SEBAGAI PARTNER --}}
{{-- ===================================================== --}}

<section class="max-w-7xl mx-auto px-6 pb-20">

    <div class="bg-indigo-600 rounded-[2.5rem] p-10 md:p-16 text-white relative overflow-hidden">

        {{-- DEKORASI --}}
        <div class="absolute -right-20 -top-20 w-64 h-64 bg-white/10 rounded-full"></div>
        <div class="absolute -left-20 -bottom-20 w-64 h-64 bg-purple-400/20 rounded-full"></div>
        ...
        <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
            ...
            <div class="max-w-2xl">
                ...
                <span class="inline-block px-4 py-1.5 bg-white/20 rounded-full text-sm font-bold uppercase tracking-wider mb-4">
                    Jadi Partner Kami
                </span>
                ...
                <p class="text-indigo-100 text-lg leading-relaxed">
                    Daftarkan diri Anda sebagai partner AmikomEventHub dan
                    kelola event Anda dengan lebih mudah. Publikasikan event,
                    kelola tiket, dan pantau transaksi dalam satu platform.
                </p>
            ...
            <div class="flex-shrink-0">
                ...
                <a
                    href="{{ route('register') }}"
                    class="inline-block px-8 py-4 bg-white text-indigo-600 rounded-2xl font-black text-lg shadow-xl hover:scale-105 hover:bg-indigo-50 transition-transform"
                >
                    Daftar Jadi Partner
                </a>
